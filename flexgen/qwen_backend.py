...
class QwenTorchDevice(LlamaTorchDevice):
    ...
    def qwen_mha_batched(self, inputs, position_ids, attention_mask, w_ln, w_q, b_q, w_k, b_k, w_v, b_v,
            w_out, n_head, n_kv_head, donate, eps, rope_theta, compress_cache, comp_config, batch_size=64):
